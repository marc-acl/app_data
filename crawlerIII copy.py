...
#se usa generador para no cargar todo a la memoria y que se impriman
#a solicitud, en este caso 13
...
with open('ausflistung.csv', 'w', newline='', encoding='utf-8') as csvfile:
    ...
    spamwriter.writerow(["Emoji", "Title", "Paragraph", "Image"])
    ...
    def generador():
        ...
        while urlBase !="":
            ...
            for i in bloque:
                ...
                yield (emoji, titles, parrs, imagenUurl)
    ...
    contador = 0
    for emoji, titles, parrs, imagenUurl in generador():
        ...
        print(emoji, titles, parrs, imagenUurl)
        print("")
